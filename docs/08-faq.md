...
| 方案 | 说明 |
|------|------|
| **换下载源** | GitHub 打不开时，用国内镜像站或机场提供的下载页 |
| **用手机流量下载** | 部分情况下，手机流量和宽带走不同的访问路径 |
| **请朋友帮忙** | 让已经能访问的朋友下载后传给你 |

**常用国内镜像站**：
- GitHub 加速：`https://ghfast.top/`、`https://ghproxy.net/`
- 直接把 GitHub 链接前加上镜像站前缀即可
...
2. **切换 Apple ID 地区**：在设置中切换地区后重新搜索（需美区 ID）
