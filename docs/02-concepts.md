...
这类聚合 app 和"机场 + 开源客户端"方案的区别，在第 [07 章](07-comparison.md)会详细对比。
...
一句话总结这一章：**科学上网 = 你从机场买订阅 → 把链接导入客户端 → 客户端通过加密通道连到代理节点 → 正常访问目标网站。** 理解了这一点，接下来我们看看该选哪个客户端——见 [03 客户端选择](03-clients.md)。

---

[← 上一篇：01 为什么需要科学上网](01-why.md) ｜ [下一篇：03 客户端选择 →](03-clients.md)
